...
% \includeonly{programs/MS_InformationTechnology}
% \usepackage{excludeonly}
% \excludeonly{cover_page}
% \includeonly{plans/BS_Cyber-SuggestedClassSchedule}
...
\fancypagestyle{catalog}[fancy]{%
	...
	\setlength\headheight{52.5pt} %% just to make the warning go away. Adjust the value after looking into the warning.
	...
	\rhead{\color{csublue}2025--2026 Catalog}
	...
	\fancyfoot[LE]{\vspace{1em}\thepage}
	\fancyfoot[RO]{\vspace{1em}\thepage}
}
...
%%% Uncomment the following two lines to use a box instead of a pdf form for the boxes.
...
\setlist[checklist]{
	...
	left=1.2em, itemindent=-1.415em, % Controls the indent on the second line. Tried to match the width of "(3)"
}
\newcommand{\cmark}{\ding{51}}%
\newcommand{\done}{\rlap{$\square$}{\raisebox{2pt}{\large\hspace{1pt}\cmark}}%
\hspace{-2.5pt}}

% reduce the spacing between items in lists
\usepackage{enumitem}
...
% Add a colon after the label in description lists
...
% Rotate column in tabular to have vertical text.
...
\include{programs/MS_InformationTechnology}
\end{Form}
