...
\subsection{Business}
\subsubsection{ACCT 210 -- Principles of Accounting I} % chktex 8
...
% \subsubsection{ACCT 211 -- Principles of Accounting II} % chktex 8
...
\subsubsection{ECON 211 -- Principles of Microeconomics} % chktex 8
...
\subsubsection{ECON 212 -- Principles of Macroeconomics} % chktex 8
...
\subsubsection{MRKT 310 -- Principles of Marketing} % chktex 8
...
\subsubsection{MGMT 310 -- Principles of Management} % chktex 8
...
\subsubsection{CRIM 210 -- Introduction to Criminal Justice} % chktex 8
...
\subsubsection{CRIM 212 -- Techniques of Criminal Investigations} % chktex 8
(3 hours) Prerequisites: CRIM 210 and CRIM 227 or PSYC 212. A study of investigative techniques used in crime scene analysis. These include but are not limited to, examination of questioned documents, fingerprint techniques, polygraph examinations, firearms identifications ballistics, toxicology, pathology, interrogation and interviewing, and photography. 

\subsubsection{CRIM 227 -- Critical Thinking and Writing in Criminal Justice} % chktex 8
...
\subsubsection{CRIM 232 -- Current Issues and Trends in Criminal Justice} % chktex 8
(3 hours) Prerequisites: CRIM 210 and CRIM 227 or PSYC 212. This course provides an examination of the current issues and trends within the criminal justice system. The student will develop an up-to-date awareness of activities within today’s criminal justice system in the areas of police, courts, and corrections. Integration of faith from both a contemporary and biblical perspective will be intertwined in the definition of Justice.

\subsubsection{CRIM 312 -- Advanced Criminal Investigative Techniques} % chktex 8
(3 hours) Prerequisites: CRIM 210, 212, and CRIM 227 or PSYC 212. This is an advanced level course for Criminal Justice majors and minors. The focus of the class will be to combine the art of investigation with the science of criminalistics.  Advances in forensics have vastly changed the criminal investigative process, and this course will integrate academic and applied approaches to advance the development of criminal investigative techniques for the undergraduate student. Note: Laboratory fee required.

\subsubsection{CRIM 455 -- Homeland Security} % chktex 8
(3 hours) Prerequisites: CRIM 210 and junior/senior status and CRIM 227 or PSYC 212. This course will define the relatively new criminal justice field of Homeland Security as well as identify and explore the definition of terrorism. The course will also visit the aspects of Counter Terrorism and Anti-Terrorism as it applies to the criminal justice discipline.


\subsection{Computer Science}

\subsubsection{CSCI 215 -- Programming in Alice} % chktex 8
...
\subsubsection{CSCI 217 -- Practical Programming and Problem Solving} % chktex 8
...
\subsubsection{CSCI 235 -- Procedural Programming} % chktex 8
...
\clearpage{}
\subsubsection{CSCI 312 -- Quantitative Modeling and Computer Simulation} % chktex 8
...
\subsubsection{CSCI 315 -- Data Structure Analysis} % chktex 8
...
\subsubsection{CSCI 316 -- Competitive Security} % chktex 8
...
\subsubsection{CSCI 325 -- Object-Oriented Programming} % chktex 8
...
\subsubsection{CSCI 330 -- Computer Architecture} % chktex 8
(4 hours) Prerequisite: MATH 330 of ENGR 220 and CSCI 325 with a grade of “C” or better. This course explores the interdependencies among assembly language, computer organization and design with a focus on the concepts that are the basis for current computer technology. Stored-program concept, computer arithmetic, datapath and control, microprogramming, logic design, truth tables, logic gates, programmable logic arrays, control, pipelining, the memory hierarchy, and caches. Lecture 3 hours, laboratory 2 hours. (Laboratory fee required) This course cannot be challenged.

\subsubsection{CSCI 332 -- Applied Networking} % chktex 8
...
\subsubsection{CSCI 334 -- User-Interface Programming} % chktex 8
...
\subsubsection{CSCI 352 -- Cyber Defense} % chktex 8
...
\subsubsection{CSCI 360 -- Introduction to Mobile Application Development} % chktex 8
...
\subsubsection{CSCI 371/372/373/374 -- Student-Directed Coursework in Computer Science} % chktex 8
...
\subsubsection{CSCI 383 -- Creative Teamwork} % chktex 8
...
\subsubsection{CSCI 401/402/403 -- Computer Science Research} % chktex 8
...
\subsubsection{CSCI 405 -- Principles of Cybersecurity} % chktex 8
...
\subsubsection{CSCI 409 -- Fundamentals of Artificial Intelligence} % chktex 8
...
\clearpage{}
\subsubsection{CSCI 412 -- Applied Artificial Intelligence} % chktex 8
(3 hours) CSCI 315 Data Structure and CSCI 332 Applied Networking. This course emphasizes the practical design, implementation, and deployment of artificial intelligence systems. Students develop data-driven applications using contemporary AI frameworks, developing practical skills in machine learning workflows, neural networks, large language models, prompt engineering, retrieval-augmented generation (RAG), agent-based systems, and model evaluation. The course also addresses system integration in networked environments, APIs, cloud and edge deployment, and the security, reliability, and ethical considerations of AI systems. Through hands-on projects, students gain experience building, fine-tuning, and deploying AI solutions that operate effectively in real-world computing contexts. Lecture 3 hours, laboratory 2 hours.

\subsubsection{CSCI 415 -- Algorithms} % chktex 8
...
\subsubsection{CSCI 419 -- Database Management} % chktex 8
...
\subsubsection{CSCI 431 -- Operating Systems} % chktex 8
...
\subsubsection{CSCI 432 -- Mobile and Wireless Networks} % chktex 8
...
\subsubsection{CSCI 433 -- Network Security} % chktex 8
...
\subsubsection{CSCI 434 -- Human-Computer Interaction} % chktex 8
...
\subsubsection{CSCI 435 -- Computer Networks} % chktex 8
...
\clearpage{}
\subsubsection{CSCI 442 -- Data Mining} % chktex 8
...
\subsubsection{CSCI 450 -- Graphics} % chktex 8
...
\subsubsection{CSCI 452 -- Network Penetration Testing and Ethical Hacking} % chktex 8
...
\subsubsection{CSCI 469/470 -- Computer Science Internship} % chktex 8
...
\subsubsection{CSCI 490/491/492 -- Exit Exam} % chktex 8
...
\subsubsection{CSCI 495 -- Systems Analysis and Software Design} % chktex 8
...
\clearpage{}
\subsubsection{CSCI 496 -- Senior Portfolio Review} % chktex 8
...
\subsubsection{CSCI 497 -- Senior Project Design} % chktex 8
...
\subsubsection{CSCI 498 -- Senior Project Construction} % chktex 8
...
\subsubsection{CSCI 499 -- Senior Project Implementation/Defense} % chktex 8
...
\subsubsection{CSCI 509 -- Artificial Intelligence} % chktex 8
(3 hours) Prerequisites: MATH 213  and CSCI 325. This course provides a comprehensive introduction to the foundational concepts, techniques, and research advancements in Artificial Intelligence (AI), complemented by hands-on projects. Students will explore a range of topics, beginning with an introduction to intelligent agents, followed by classical AI topics such as logic, knowledge representation, search algorithms, Bayesian networks, and Hidden Markov Models. The latter part of the course transitions to machine learning fundamentals, starting with supervised learning and progressing to deep learning. In addition to technical knowledge, students will engage in projects, ethics, and presentations. Students will analyze the ethical implications of AI and present their findings. The course will conclude with a Final Exam to assess the comprehensive understanding of the topics covered. Graduate students will review some of the most recent AI research in a written paper and presentations for the class.

\subsubsection{CSCI 512 -- Applied Artificial Intelligence} % chktex 8
(3 hours) CSCI 315 Data Structure and CSCI 332 Applied Networking. This course emphasizes the practical design, implementation, and deployment of artificial intelligence systems. Students develop data-driven applications using contemporary AI frameworks, developing practical skills in machine learning workflows, neural networks, large language models, prompt engineering, retrieval-augmented generation (RAG), agent-based systems, and model evaluation. The course also addresses system integration in networked environments, APIs, cloud and edge deployment, and the security, reliability, and ethical considerations of AI systems. Through hands-on projects, students gain experience building, fine-tuning, and deploying AI solutions that operate effectively in real-world computing contexts.

\subsubsection{CSCI 515 -- Advanced Algorithms} % chktex 8
...
\subsubsection{CSCI 531 -- Advanced Operating Systems} % chktex 8
...
\subsubsection{CSCI 534 -- Human-Computer Interaction} % chktex 8
...
\subsubsection{CSCI 535 -- Advanced Computer Networks} % chktex 8
...
\subsubsection{CSCI 540 -- Software Testing and Maintenance} % chktex 8
...
\subsubsection{CSCI 541 -- Distributed Database Systems} % chktex 8
...
\clearpage{}
\subsubsection{CSCI 542 -- Data Mining} % chktex 8
...
\subsubsection{CSCI 552 -- Network Penetration Testing and Ethical Hacking} % chktex 8
...
\subsubsection{CSCI 555 -- Compiler Construction} % chktex 8
...
\subsubsection{CSCI 560 -- Advanced Computer Architecture} % chktex 8
...
\subsubsection{CSCI 590 -- Applied Cryptography} % chktex 8
...
\subsubsection{CSCI 635 -- Advanced Topics in Network Security} % chktex 8
...
\subsubsection{CSCI 640 -- Open-Source Software Engineering} % chktex 8
...
\subsubsection{CSCI 650 -- Fieldwork} % chktex 8
...
\subsubsection{CSCI 697 -- Research I} % chktex 8
...
\subsubsection{CSCI 698 -- Research II} % chktex 8
...
\subsubsection{MATH 130 -- Precalculus} % chktex 8
...
\subsubsection{MATH 209 -- Calculus for Business} % chktex 8
...
\subsubsection{MATH 213 -- Probability and Statistics} % chktex 8
...
\subsubsection{MATH 221 -- Calculus I} % chktex 8
...
\subsubsection{MATH 222 -- Calculus II} % chktex 8
...
\subsubsection{MATH 321 -- Calculus III} % chktex 8
...
\subsubsection{MATH 326 -- Linear Algebra} % chktex 8
...
\subsubsection{MATH 330 -- Discrete Mathematics} % chktex 8
